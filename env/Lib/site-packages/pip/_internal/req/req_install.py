...
class InstallRequirement(object):
    ...
    def __init__(
        ...
        # is not necessarily the directory where pyproject.toml or setup1.py is
    ...
    def setup_py_path(self):
        ...
        setup_py = os.path.join(self.unpacked_source_directory, 'setup1.py')
    ...
    def load_pyproject_toml(self):
        ...
        follow the PEP 517 or legacy (setup1.py) code path.
        """
    ...
    def prepare_metadata(self):
        ...
        Under legacy processing, call setup1.py egg-info.
        """
    ...
    def install(
        ...
        # the setup1.py call with the ones from the requirements file.
        # Options specified in requirements file override those
        # specified on the command line, since the last option given
        # to setup1.py is the one that is used.
